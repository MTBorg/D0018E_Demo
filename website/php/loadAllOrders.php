<?php
    function loadAllOrders(){
        ...
        if($orders){
            ...
            echo '<tr class="ordersTableHeader"> <th> Order ID </th> <th> User ID </th> <th> Email </th> <th> </th> </tr>';
            while($row = mysqli_fetch_object($orders)){
                ...
                echo '<tr>
                        ...
                        <td>'.$user_id.' </td>
                        <td>'.$user_email.'</td>
                        <td><button  onclick=\'location.href="adminOrderPage.php?order_id='.$order_id.'"\'>View </button></td>
                        </tr>';
